function B = build_bipartite_graph(img,para,seg,seg_lab_vals,seg_edges,featPath)
...
for k = 1:length(seg) % for each over-segmentation
    ...
    W = simOfSuperpixels(img,seg{k},seg_lab_vals{k},seg_edges{k},para,featPath,k);% here ,k is used to load the precomputed superpixel distance matrix
